...
$expect(str_contains($routes, "return_module=automation") && str_contains($routes, "input('return_module', '') === 'automation'"), 'Federated logout must preserve the originating module for the next central login.');
