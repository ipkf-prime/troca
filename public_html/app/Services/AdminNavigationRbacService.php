...
class AdminNavigationRbacService extends BaseService
{
    ...
    public function routePermissions(): array
    {
        return [
            ...
            '/admin/ticketing/participants' => 'ticketing.project.manage',
            '/admin/ticketing/participants/core' => 'ticketing.project.manage',
            '/admin/ticketing/participants/manual' => 'ticketing.project.manage',
            ...
            '/admin/system/help-texts/override/save' => 'admin.ui_content.manage',
            '/admin/communications/templates' => 'admin.settings.manage',
            '/admin/communications/templates/save' => 'admin.settings.manage',
            '/admin/communications/templates/preview' => 'admin.settings.manage',
            '/admin/communications/templates/test-send' => 'notifications.send.manage',
    ...
    public function systemNavigation(?int $userId): array
    {
        return $this->filterNavigation($userId, [
            ...
            ['key' => 'public-page', 'title' => 'مدیریت صفحه عمومی', 'url' => '/admin/public-page', 'permission' => 'admin.settings.manage'],
    ...
    public function debug(?int $userId): array
    {
        $system = $this->navigationDebugRows($userId, [
            ...
            ['key' => 'public-page', 'url' => '/admin/public-page', 'permission' => 'admin.settings.manage'],
