...
<?php ob_start(); ?>
<?php if($attachmentStatus==='uploaded'):?><div class="admin-alert admin-alert--success">پیوست با موفقیت ثبت شد.</div><?php elseif($attachmentStatus==='removed'):?><div class="admin-alert admin-alert--success">پیوست با موفقیت حذف شد.</div><?php elseif($attachmentStatus==='metadata_updated'):?><div class="admin-alert admin-alert--success">مشخصات پیوست با موفقیت ویرایش شد.</div><?php elseif($attachmentStatus==='attachment_limit_reached'):?><div class="admin-alert admin-alert--danger">برای هر مکاتبه حداکثر <?=admin_h($attachmentPolicyMaxFilesFa)?> پیوست قابل ثبت است.</div><?php elseif($attachmentStatus==='primary_attachment_exists'):?><div class="admin-alert admin-alert--danger">برای هر مکاتبه فقط یک فایل اصلی قابل ثبت است.</div><?php elseif($attachmentStatus==='invalid_attachment_role'):?><div class="admin-alert admin-alert--danger">نوع پیوست معتبر نیست.</div><?php elseif($attachmentStatus==='attachment_not_editable'):?><div class="admin-alert admin-alert--danger">ویرایش مشخصات پیوست فقط برای پیش‌نویس مجاز است.</div><?php elseif($attachmentStatus==='attachment_not_removable'):?><div class="admin-alert admin-alert--danger">حذف پیوست فقط برای پیش‌نویس مجاز است.</div><?php elseif($attachmentStatus!==''):?><div class="admin-alert admin-alert--danger">عملیات پیوست انجام نشد؛ نوع یا حجم فایل را بررسی کنید.</div><?php endif;?>
