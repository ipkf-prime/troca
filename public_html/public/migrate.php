...
try {
    ...
    $manager->migrations([
        ...
        new \IPKF\Database\Migrations\ExposeAutomationSecretariatNavigation(),
        ...
        new \IPKF\Database\Migrations\CreateDynamicScopedAccessFoundation(),
        new \IPKF\Database\Migrations\SeedExistingDynamicRoleGovernance(),
        new \IPKF\Database\Migrations\AddRoleKindSortOrder(),
        new \IPKF\Database\Migrations\CreatePublicLandingFoundation(),
        new \IPKF\Database\Migrations\PromotePublicLandingIdentityToSystemTheme(),
        new \IPKF\Database\Migrations\CreatePublicRuntimePresence(),
        new \IPKF\Database\Migrations\CreateNotificationApprovalWorkflowFoundation(),
        new \IPKF\Database\Migrations\EnableNotificationApprovalManagement(),
